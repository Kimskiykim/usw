#!/usr/bin/env python3
"""Testing wrapper for the shared append-only evidence contract."""
...
def append_testing_evidence(
    ...
    *,
    ...
    return CONTRACT["append_task_evidence"](
        project_root, task_root, role="Testing", evidence_id=evidence_id,
        contract_revision=contract_revision, source_identity=source_identity,
        command=command, result=result, finding=finding, timestamp=timestamp,
    )
