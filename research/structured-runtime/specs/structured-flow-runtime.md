# structured-flow-runtime Specification

## Purpose
Define plain Markdown flow execution as the default and keep strict v1/version-2
parsing and orchestration behind an explicit experimental selector.
