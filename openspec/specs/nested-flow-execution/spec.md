# nested-flow-execution Specification

## Purpose
Define nested named-flow execution owned by a root executor, with immutable
child invocations, shared root identity, and no child-owned durable runtime.
